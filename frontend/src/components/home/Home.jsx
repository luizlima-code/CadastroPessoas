...
export default class Home extends Component {
  ...
  removeDuplicateCity() {
    const listCitys = this.state.list.map(
  ...
  calculateMediaAge() {
    ...
    return Math.floor(
      listAge.reduce((acumulador, idade) => (acumulador += idade)) /
        listAge.length
    );
  }
      ...
      return (
        ...
        >
          ...
          <div key={user.id}>
            ...
            <hr />
            <p>Cidades presentes em cadastro:{this.removeDuplicateCity()}.</p>
            <p>
              Menor idade entre as pessoas cadastradas é:{" "}
              {Math.min(...this.calculateAge())}.
            </p>
            <p>
              Maior idade entre as pessoas cadastradas é:{" "}
              {Math.max(...this.calculateAge())}.
            </p>
            <p>
              Média de idade das pessoas cadastradas é:{" "}
              {this.calculateMediaAge()}.
            </p>
          </div>
        </Main>
      );
